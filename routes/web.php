...
Route::post('/product/review', [ShopController::class, 'store_review'])->name('product.review.store');
...
Route::middleware(['auth',AuthAdmin::class])->group(function () {
    ...
    Route::post('/admin/product/upload-variant-gallery',[AdminController::class,'uploadVariantGallery'])->name('admin.product.upload.variant.gallery');

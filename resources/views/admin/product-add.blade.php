                                ...
                                <form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="{{ route('admin.product.store') }}">
                                    ...
                                    <div class="wg-box">
                                        ...
                                        <div class="gap22 cols">
                                            ...
                                            @error('brand_id') <sapn class="alert alert-danger text-center">{{ $message }} @enderror 
                                        </div>
                                ...
                                <img src="images/upload/upload-1.png" alt="">
                                        ...
                                        <div class="cols gap22">
                                            <fieldset class="name">
                                                ...
                                                <input class="mb-10" type="text" placeholder="Enter regular price" name="regular_price" tabindex="0" value="{{ old('reqular_price') }}" aria-required="true" required="">
                                            </fieldset>
